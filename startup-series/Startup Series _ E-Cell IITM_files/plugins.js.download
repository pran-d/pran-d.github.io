...
!(function (e) {
	var t = function (t, n) {
		...
		var i = function () {
				...
				n.forEach(function (n) {
					i === n.name
						? n.inside || (e(window).trigger("inside-" + n.name), (n.inside = !0))
						: (n.inside = !1),
						t < n.width &&
							(n.less ||
						...
						t >= n.width &&
							(n.greaterEqual ||
								(e(window).trigger("greaterEqualTo-" + n.name), (n.greaterEqual = !0), (n.less = !1)),
							t > n.width &&
								(n.greater ||
									(e(window).trigger("greaterThan-" + n.name), (n.greater = !0), (n.less = !1))));
				});
			},
			a = function () {
				var t = e(window);
				...
				s && clearTimeout(s),
					(s = setTimeout(function (t) {
						...
						(n = r.getBreakpoint()) !== r.currentBp &&
							(e(window).trigger({ type: "breakpoint-change", from: r.currentBp, to: n }),
							(r.currentBp = n)),
							i();
					}, r.settings.buffer));
			}),
	...
	e.fn.twittie = function () {
		...
		var n = function (e) {
			...
			u = function (e) {
				for (
					var t = r.template,
						a = ["date", "tweet", "avatar", "url", "retweeted", "screen_name", "user_name"],
						n = 0,
						s = a.length;
					s > n;
					n++
				...
				i.find("span").fadeOut("fast", function () {
					...
					for (var t = 0; t < r.count; t++) {
						...
						var o = {
							...
							date: s(l.created_at),
							tweet: n(
								l.retweeted ? "RT @" + l.user.screen_name + ": " + l.retweeted_status.text : l.text
							),
		...
		var i = {
			...
			setEndpoints: function () {
				return {
					...
					usersMediaRecent:
						"/users/self/media/recent/?&count=" + this.options.max + "&access_token=" + this.accessToken,
					tagsMediaRecent:
						"/tags/" +
						this.options.query +
						"/media/recent?&count=" +
			...
			display: function (e) {
				...
				if (
					...
					i
						...
						: this.$elem.append(t(this.options.wrapEachWith).append(this.messages.notFound));
				else {
					...
					for (var u = 0; u < c; u++)
						"small" === h
							...
							(a = t("<img>", { alt: n, attr: { height: o, width: r }, src: d })),
							(s = t("<a>", { href: e.data[u].link, target: "_blank", title: n }).append(a)),
	...
	(String.format = function () {
		...
		t.extend(i.prototype, {
			...
			buildNotify: function () {
				...
				(this.$ele = t(
					String.format(this.settings.template, this.settings.type, s.title, s.message, s.url, s.target)
				)),
					this.$ele.attr(
			...
			placement: function () {
				...
				this.$ele.css(e).addClass(this.settings.animate.enter),
					...
					this.settings.newest_on_top === !0 &&
						((i = parseInt(i) + parseInt(this.settings.spacing) + this.$ele.outerHeight()),
						this.reposition(i)),
			...
			bind: function () {
				...
				if (
					...
					var i = setInterval(function () {
						...
						if (
							("false" === s.$ele.data("data-hover") && "pause" === s.settings.mouse_over) ||
